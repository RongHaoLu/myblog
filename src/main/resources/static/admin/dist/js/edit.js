...
$('#saveButton').click(function () {
    ...
    //     return;
    // }
    var url = '/rh/blogs/save';
    var swlMessage = '保存成功';
    var data = {
        "title": blogTitle, "first_picture": blogSubUrl, "type_id": blogCategoryId,
        "flag": blogTags, "content": blogContent, "published": blogStatus,
        "commentabled": enableComment,"recommend": recommend,"description":description
    };
    if (blogId > 0) {
        url = '/rh/blogs/update';
        swlMessage = '修改成功';
        data = {
            "title": blogTitle, "first_picture": blogSubUrl, "type_id": blogCategoryId,
            "flag": blogTags, "content": blogContent, "published": blogStatus,
            "commentabled": enableComment,"recommend": recommend,"id":blogId,"description":description
        };
    }
    console.log(data);
    $.ajax({
